            ...
            <div class="breadcrumb__container row align-items-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb non-bg">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Change Email</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="register__wrapper row">
                ...
                <div class="register__content__wrapper">
                    ...
                    <%
                        if (u != null) {
                    %>
                    <form action="<%=Utils.fullPath("UserEmailUpdateServlet")%>" method="post">
                        ...
                        <div class="information">
                            <%
                                String errEmail = (String) request.getAttribute("errEmailUpdate");
                                if (errEmail != null) {
                            %>
                            <div>
                                <label><span>*</span>E-Mail</label>
                                <input type="text" name="emailUpdate" required="required" placeholder="E-Mail" value="<%=request.getParameter("emailUpdate")%>">
                            </div>
                            ...
                            <div>
                                <label><span>*</span>E-Mail</label>
                                <input type="text" name="emailUpdate" required="required" placeholder="E-Mail" value="<%=u.getEmail()%>">
                            </div>
                            <%
                                }
                            %>
